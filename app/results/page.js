    ...
    return (
        <main className="results-container bg-[#0A0A0A] min-h-screen text-white font-sans selection:bg-[#FF1801] selection:text-white pb-20">
            ...
            <PageWrapper>
                ...
                {/* SEASON SELECTOR */}
                <section className="season-select-container px-6 md:px-12">
                ...
                {/* RACE SELECTOR TABS */}
                <section className="race-selector px-6 md:px-12">
                ...
                {loading ? (
                    ...
                    <>
                        {/* RACE HEADER */}
                        <section className="race-header-banner fade-up px-6 md:px-12">
                        ...
                        {/* RACE CLASSIFICATION */}
                        <section className="results-section px-6 md:px-12">
