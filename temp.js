...
function ResultsContent() {
    ...
    return (
        <main className="results-container bg-[#0A0A0A] min-h-screen text-white font-sans selection:bg-[#FF1801] selection:text-white pb-20">
            <Navbar />
            <PageWrapper>
                <PageHeader
                    title="Race"
                    subtitle="Results"
                    eyebrow={`${selectedSeason} Formula One Season`}
                    watermark={selectedSeason.toString()}
                >
                    {selectedSeason !== new Date().getFullYear() && (
                        <>
                            <div className="header-stat">
                                <div className="header-stat-val text-yellow-400">
                                    {schedule.filter(r => new Date(r.date) < new Date()).length}
                                </div>
                                <div className="header-stat-label">RACES COMPLETE</div>
                            </div>
                            <div className="header-stat">
                                <div className="header-stat-val text-white">
                                    {schedule.length}
                                </div>
                ...
                {/* SEASON SELECTOR */}
                <section className="season-select-container px-6 md:px-12 py-6 md:py-8">
                    <div className="container-custom flex items-center gap-16">
                ...
                {/* RACE SELECTOR TABS */}
                <section className="race-selector px-6 md:px-12 border-b border-white/5">
                    <div className="container-custom race-tabs">
                        {schedule.map((race) => (
                            <button
                                key={race.round}
                ...
                {loading ? (
                    ...
                    <>
                        {/* RACE HEADER */}
                        <section className="race-header-banner fade-up px-6 md:px-12 py-12 md:py-20">
                            <div className="container-custom grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-10 items-center">
                        ...
                        {/* RACE CLASSIFICATION */}
                        <section className="results-section px-6 md:px-12 py-12 md:py-20">
